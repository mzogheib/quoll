    ...
    <div className="side-bar">
      ...
      <div className="side-bar__nav">
        <div className="side-bar__nav-upper">
          <NavLink to={routesHash.home.path} exact className="side-bar__item" activeClassName="side-bar__link-active">
        ...
        <div className="side-bar__nav-lower">
          <NavLink to={routesHash.settings.path} className="side-bar__item" activeClassName="side-bar__link-active">
            <div className="side-bar__link-icon"><SettingsIcon size={40} /></div>
            <div className="side-bar__link-active-indicator"></div>
          </NavLink>
          <div className="side-bar__item" onClick={props.onHelpClick}>
            <div className="side-bar__link-icon"><HelpIcon size={40} /></div>
          </div>
        </div>
      </div>
    </div>
