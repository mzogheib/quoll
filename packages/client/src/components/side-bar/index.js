    ...
    <div className="side-bar">
      ...
      <div className="side-bar__nav">
        <div className="side-bar__nav-upper">
          <NavLink to={routesHash.home.path} exact className="side-bar__link" activeClassName="side-bar__link-active">
        ...
        <div className="side-bar__nav-lower">
          <NavLink to={routesHash.settings.path} className="side-bar__link" activeClassName="side-bar__link-active">
