...
function adapter(activities) {
  return activities
    ...
    .map(activity => {
      ...
      const locationStart = activity.start_latlng && { latitude: activity.start_latlng[0], longitude: activity.start_latlng[1] };
      const locationEnd = activity.end_latlng && { latitude: activity.end_latlng[0], longitude: activity.end_latlng[1] };
